...
- conda activate FireFusionNet
#### Building
- Download data for non-API features (all except NASA Modis)
   - *Ensure paths in* `path_config` match
#### Training
- Run `python -m fire_fusion.train.py`
   - Note: requires .zarr files under `data/train`, `data/eval`, and `eval/test`
