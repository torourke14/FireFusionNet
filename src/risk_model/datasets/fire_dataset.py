...
from .sources import build_data
...
class RoadDataset(Dataset):
    ...
    def get_transform(self, transform_pipeline: str):
        ...
        if transform_pipeline not in ["default", "state_only", "aug"]:
            raise ValueError(f"Invalid transform pipeline type!")
        ...
        if xform is None:
            raise ValueError(f"Invalid transform specified!")
