# Data (mostly from online DL's, some APis), otherwise APIs as below.

*To rebuild data, specific data would need to be rebuilt from the below*
...
- [MOD13Q1 Data/Spec](https://ladsweb.modaps.eosdis.nasa.gov/missions-and-measurements/products/MOD13Q1)
- [MODIS User Guide](https://vip.arizona.edu/MODIS_UsersGuide.php)
- [MCD15A2H Data/Spec](https://ladsweb.modaps.eosdis.nasa.gov/missions-and-measurements/products/MCD15A2H)
- [MCD64A1 Data/Spec](https://ladsweb.modaps.eosdis.nasa.gov/missions-and-measurements/products/MCD64A1#overview)
